...
{
    public partial class AddRimsReq : Form
    {
        public AddRimsReq()
        {
            InitializeComponent();
        ...
        private void AddRimsReq_Load(object sender, EventArgs e)
        {
        ...
        private void Add_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                if (!string.IsNullOrEmpty(TimeTextBox.Text) && !string.IsNullOrEmpty(DateTextBox.Text))
                {
                    ...
                    SqlCommand AddCommand = new SqlCommand("insert into Selling_rims (id_user_accounts, id_customer, id_rims, date_of_sale, time_of_sale)" +
                    "VALUES  (@id_user_accounts, @id_customer, @id_rims, @date_of_sale, @time_of_sale)", connection);
                    ...
                    if (!string.IsNullOrEmpty(RimsComboBox.Text))
                    {
                        ...
                        while (reader.Read())
                        {
                            ...
                            AddCommand.Parameters.AddWithValue("@id_rims", Service_type_ID1);
                    ...
                    {
                        AddCommand.Parameters.AddWithValue("@date_of_sale", DateTextBox.Text);
                    }

                    if (!string.IsNullOrEmpty(TimeTextBox.Text))
                    {
                        AddCommand.Parameters.AddWithValue("@time_of_sale", TimeTextBox.Text);
                    }
